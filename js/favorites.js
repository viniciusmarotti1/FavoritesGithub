...
//class lógica e estrutura dos dados
...
//class vizualização e eventos do html
    ...
    createRow(){
        ...
        <td class="user">
            ...
            <a href="" target="_blank">
                <p>Vinicius Marotti</p>
                <span>viniciusmarott1</span>
            </a>
        </td>
        <td class="repositories">45</td>
        <td class="followers">12</td>
        <td><button class="button-remove">&times;</button></td>
        `
        return tr
    }
    removeAllTr(){
